    ...
    # # zstyle :compinstall filename '/hom            e/gabriel/.zshrc'
    # zstyle ':completion:*' menu select
    # autoload -Uz compinit
    # compinit
    # # End of lines added by compinstall

    # # RPS1='\[\e[32m\]┌──(\[\e[38;5;32;1m\]\u\[\e[0;32m\]@\[\e[38;5;32;1m\]\t\[\e[0;32m\])\[\e[36m\]-[\[\e[0m\]\    w\[\e[32m\]]└─\n\$\[\e[0m\] '
    # PS1='%{\e[32m%}┌──(%{\e[38;5;32;1m%}%n%{\e[0;32m%}@%{\e[38;5;32;1m%}%t%{\e[0;32m%})%{\e[36m%}-%{\e[0m%}%~%{\e[32m%}]└─\n$ %{\e[0m%}'
...
if [ "$color_prompt" = yes ]; then
    PROMPT=$'%F{%(#.blue.green)}┌──${debian_chroot:+($debian_chroot)──}(%B%F{%(#.red.blue)}%n%(#.💀.@)%*%b%F{%(#.blue.green)})-[%B%F%(6~.%-1~/…/%4~.%5~)%b%F{%(#.blue.green)}]\n└─%B%(#.%F{red}#.%F{blue}$)%b%F{reset} '
